    ...
    <body data-ma-theme="green" id="bdlogin" style="margin:0px;padding:0px;">
        ...
        <div class="login__block active">
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                ...
                <input class="d-inline-flex p-2 mt-4 form-control" placeholder="Password" type="password" name="user_password" required> </input><br/><br/>
...
{   //intialize variables
    ...
    while($row = pg_fetch_array($result))
    {
        ...
        if($user_eml == $temp_eml AND $user_pass == $temp_pass)
        {
            ...
            redirect($url);
            exit();
        } elseif($user_eml == $temp_eml AND $user_pass != $temp_pass) {
            $verify = false;
    ...
    if($verify)
    {
        $sql_query = "INSERT INTO public.tbl_users (fld_email, fld_password) VALUES('$user_eml', '$user_pass')";
