...
<html lang="en"><head ontouchmove="event.preventDefault();"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <meta http-equiv="Content-Security-Policy" content="upgrade-insecure-requests">
        ...
        <style>
          ...
          min-height: 100%; background:#F3F6F7;min-width:100%;
          position:absolute;
          top: 0;
          right: 0;
          bottom: -500;
    ...
    <body data-ma-theme="green">
      <div class="g-signin2" style="display:none;" data-gapiscan="true" data-onload="true"><div style="height:36px;width:120px;" class="abcRioButton abcRioButtonLightBlue"><div class="abcRioButtonContentWrapper"><div class="abcRioButtonIcon" style="padding:8px"><div style="width:18px;height:18px;" class="abcRioButtonSvgImageWithFallback abcRioButtonIconImage abcRioButtonIconImage18"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" viewBox="0 0 48 48" class="abcRioButtonSvg"><g><path fill="#EA4335" d="M24 9.5c3.54 0 6.71 1.22 9.21 3.6l6.85-6.85C35.9 2.38 30.47 0 24 0 14.62 0 6.51 5.38 2.56 13.22l7.98 6.19C12.43 13.72 17.74 9.5 24 9.5z"></path><path fill="#4285F4" d="M46.98 24.55c0-1.57-.15-3.09-.38-4.55H24v9.02h12.94c-.58 2.96-2.26 5.48-4.78 7.18l7.73 6c4.51-4.18 7.09-10.36 7.09-17.65z"></path><path fill="#FBBC05" d="M10.53 28.59c-.48-1.45-.76-2.99-.76-4.59s.27-3.14.76-4.59l-7.98-6.19C.92 16.46 0 20.12 0 24c0 3.88.92 7.54 2.56 10.78l7.97-6.19z"></path><path fill="#34A853" d="M24 48c6.48 0 11.93-2.13 15.89-5.81l-7.73-6c-2.15 1.45-4.92 2.3-8.16 2.3-6.26 0-11.57-4.22-13.47-9.91l-7.98 6.19C6.51 42.62 14.62 48 24 48z"></path><path fill="none" d="M0 0h48v48H0z"></path></g></svg></div></div><span style="font-size:13px;line-height:34px;" class="abcRioButtonContents"><span id="not_signed_innqi7njd53u7g" style="display: none;">Sign in</span><span id="connectednqi7njd53u7g" style="">Signed in</span></span></div></div></div>
        <main class="main">
                ...
                <ul class="top-nav">
                    ...
                    <li class="dropdown hidden-xs-down">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          <a data-action="fullscreen" class="dropdown-item"><i class="zmdi zmdi-fullscreen zmdi-hc-fw"></i> Toggle Fullscreen</a>
                            <a class="dropdown-item enable" id="toggle_sidebar"><i class="zmdi zmdi-flip zmdi-hc-fw"></i>Hide Sidebar</a>
            ...
            <aside class="sidebar">
                <div class="scroll-wrapper scrollbar-inner" style="position: relative;"><div class="scrollbar-inner scroll-content" style="height: 791.5px; margin-bottom: 0px; margin-right: 0px; max-height: none;">
                    <div class="user">
                    ...
                    <ul class="navigation">
                        ...
                        <li id="nav_digitalservices" class="navigation__active"><a href="https://mydcampus.dlsl.edu.ph/#/digitalservices"><i class="fa-solid fa-shapes"></i> Digital Services</a></li>
                        ...
                        <li>
                          ...
                          <ul class="submenu">
                            <div class="sub1">
                              ...
                              <li> 
                                <ul class="suboption">
                                  <li><label class="change-theme-button" id="change-config1-bp" onclick="dlslColors1();">DLSL Colors 1</label></li>
                                  <li><label class="change-theme-button" id="change-config2-bp" onclick="dlslColors2();">DLSL Colors 2</label></li>
                                  <li><label class="change-theme-button" id="change-config3-bp" onclick="neutralTextBox();">Neutral Textbox</label></li>
                                  <li><label class="change-theme-button" id="change-config4-bp" onclick="bpwCentered();">Centered Botpress Branding</label></li>
                                  <li><label class="change-theme-button" id="change-config5-bp" onclick="bpwTall();">Tall Chatbox</label></li>
                                  <li><label class="change-theme-button" id="enable-dark-theme" onclick="toggleDarkTheme();">Toggle dark theme</label></li> <!-- toggleDarkTheme() function at the bottom; around line 930 --->
                                </ul>
                              </li>
                            </div>
                            <div class="sub2">
                              ...
                              <li> 
                                <ul class="suboption">
                                  <li><label class="accessibility-option" id="zoomInChatbot" onclick="zoom();">Zoom-in Chatbot</label></li>
                                  <li><label class="accessibility-option">Placeholder</label></li>
                                </ul>
                              </li>
                            </div>
                          </ul>
...
<section class="content" id="stage">
    <div class="row groups"><div class="col-xl-2 col-lg-3 col-sm-4 col-6 ">
        ...
        </div><div class="col-xl-2 col-lg-3 col-sm-4 col-6 " style="display: none;">
        ...
        </div></div><hr style="background-color:#e0e3e4">
<br>
<header class="content__title">
  ...
  <div class="row groups"><div class="col-xl-2 col-lg-3 col-sm-4 col-6 ">
        ...
        <script src="assets/modules/channel-web/inject.js"></script>
          ...
          -->
<div id="search_stage_wrapper" class="fademe"><div class="content__inner"><a id="close_search">BACK TO PAGE</a>
</div>
</div>
        </main>
        ...
        <div class="modal fade" id="modal-feedback">
            <div class="modal-dialog ">
                <div class="modal-content">
                    ...
                    .furious{background-image:url(modules/feedback/emoji/1.png);}
                    .sad{background-image:url(modules/feedback/emoji/2.png);}
                    .normal{background-image:url(modules/feedback/emoji/3.png);}
                    .happy{background-image:url(modules/feedback/emoji/4.png);}
                    .brilliant{background-image:url(modules/feedback/emoji/5.png);}

                    .cc-selector-2 input:active +.optioncard-cc, .cc-selector input:active +.optioncard-cc{opacity: .9;}
                    .cc-selector-2 input:checked +.optioncard-cc, .cc-selector input:checked +.optioncard-cc{
                        -webkit-filter: none;
                           -moz-filter: none;
                                filter: none;
                    }
...
/*
      document.getElementById('change-config1-bp').addEventListener('click', function() {
        if (darkThemeFlag == false) {
          ...
          Object.assign(lastConfig, {
          extraStylesheet:'assets/modules/channel-web/examples/Themes/Dark_Green_Input/customDark.css'
          })
        }
      ...
      document.getElementById('change-config2-bp').addEventListener('click', function() {
        if (darkThemeFlag == false) {
          Object.assign(lastConfig, {
          extraStylesheet:'assets/modules/channel-web/examples/Themes/Light_Green_Input/custom.css'
          })
        }

        else {
          Object.assign(lastConfig, {
          extraStylesheet:'assets/modules/channel-web/examples/Themes/Light_Green_Input/customDark.css'
          })
        }
      ...
      document.getElementById('change-config3-bp').addEventListener('click', function() {
        if (darkThemeFlag == false) {
          Object.assign(lastConfig, {
          extraStylesheet:'assets/modules/channel-web/examples/Themes/Neutral_Send_Box/custom.css'
          })
        }

        else {
          Object.assign(lastConfig, {
          extraStylesheet:'assets/modules/channel-web/examples/Themes/Neutral_Send_Box/customDark.css'
          })
        }
      ...
      document.getElementById('change-config4-bp').addEventListener('click', function() {
        if (darkThemeFlag == false) {
          Object.assign(lastConfig, {
          extraStylesheet:'assets/modules/channel-web/examples/Themes/Dark_Green_Input_Center_Footer/custom.css'
          })
        }

        else {
          Object.assign(lastConfig, {
          extraStylesheet:'assets/modules/channel-web/examples/Themes/Dark_Green_Input_Center_Footer/customDark.css'
          })
        }
      ...
      document.getElementById('change-config5-bp').addEventListener('click', function() {
        if (darkThemeFlag == false) {
          Object.assign(lastConfig, {
          extraStylesheet:'assets/modules/channel-web/examples/Themes/Tall/custom.css'
          })
        }

        else {
          Object.assign(lastConfig, {
          extraStylesheet:'assets/modules/channel-web/examples/Themes/Tall/customDark.css'
          })
        }
...
/*
      document.getElementById('enable-dark-theme').addEventListener('click', function() {
        //if else statement to check if dark theme is enabled
...
*/
	...
	<!-- Dynamic Chatbox JS Injection into iframe -->
	<script>
	...
	<script>
		...
		function dlslColors2() {
			...
			var targetDiv = frames[0].document.getElementById('input-message');
      ...
      if (scalePoint > 1.04 && scalePoint <= 1.06) {
        tallPercent = 95;
      }

      else if (scalePoint > 1.06) {
        tallPercent = 90;
      }
